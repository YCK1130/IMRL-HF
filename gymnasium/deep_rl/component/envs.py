...
from stable_baselines3.common.vec_env import VecFrameStack as FrameStack_
...
class DummyVecEnv(VecEnv):
    ...
    def get_attr(self, attr_name: str, indices: VecEnvIndices = None) -> List[Any]:
        # print(self.envs[0].get_wrapper_attr(attr_name))
        return [self.envs[0].get_wrapper_attr(attr_name)]
