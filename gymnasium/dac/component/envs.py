...
# class OriginalReturnWrapper(gymnasium.Wrapper):
...
#         return super().env_method(method_name, *method_args, indices, **method_kwargs)
#
...
class Task:
    def __init__(self,
        ...
        envs = [lambda: gymnasium.make(name, render_mode=None)
                for i in range(num_envs)]
        # self.env = DummyVecEnv(envs) if single_process else SubprocVecEnv(envs)
